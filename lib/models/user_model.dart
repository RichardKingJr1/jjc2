...
//: json[""] == null ? null : json[""],
  ...
  /* factory UserModel.fromJson(Map<String, dynamic> json) => UserModel(
    ...
    myLib: json['myLib'] == null ? null : List<AulaModel>.from((json['myLib'] as List).map((x) => AulaModel.fromJson(json))),
    myLibNogi: json['myLibNogi'] == null ? null : List<AulaModel>.from((json['myLibNogi'] as List).map((x) => AulaModel.fromJson(json))),
    propTec: json['propTec'] == null ? null : List<AulaModel>.from((json['propTec'] as List).map((x) => AulaModel.fromJson(json))),
    agrupamento: json['agrupamento'] == null ? null : List<String>.from((json['agrupamento'] as List).map((x) => x)),
  );  */
